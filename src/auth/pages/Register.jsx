...
export const Register = () => {
    ...
    const onRegister = async (event) => {
        ...
        if (isValidRegister) {
            ...
            setIsErrorModalOpen(true); // Mostrar la modal de error si el registro no fue exitoso
        }
    }
    ...
    return (
        <div className="bg-gray-100 flex justify-center items-center h-screen">
            ...
            <div className="lg:p-36 md:p-52 sm:p-20 p-8 w-full lg:w-1/2">
                ...
                <div className="mb-4">
                    <label htmlFor="displayName" className="block text-gray-600">Username</label>
                    <input
                        type="text"
                        name="displayName"
                        id="displayName"
                ...
                <br />
                {errorMessage && (
                    <div className={`fixed z-10 inset-0 overflow-y-auto ${isErrorModalOpen ? 'block' : 'hidden'}`}>
                        <div className="flex items-center justify-center min-h-screen">
                            ...
                            <div className="relative bg-white p-8 rounded-lg">
                                <div className="flex justify-between items-center mb-4">
                                    <h2 className="text-xl font-semibold text-blcak-700">Error</h2>
                                    <button className="mt-4 bg-violet-900 hover:bg-gray-500 text-white rounded-md py-2 px-4 text-sm font-medium" onClick={closeErrorModal}>Close</button>
                                </div>
